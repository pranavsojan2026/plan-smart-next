      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-[700px] flex items-center">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
            <h1 className="text-5xl md:text-7xl font-bold mb-8 text-white leading-[1.1]">
              Plan Your Perfect <br className="hidden md:block" />
              <span className="text-primary">Event</span>
            </h1>
            <p className="text-xl md:text-2xl mb-10 max-w-2xl text-gray-200 leading-relaxed">
            ...
            <Link href="/auth/user-signup">
              <Button size="lg" variant="default" className="text-lg px-8 py-6 shadow-xl">
